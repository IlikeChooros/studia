...
INSERT INTO Aparat VALUES ('Model123', 1, 100, 1, -100, 'cos');
INSERT INTO Matryca(przekatna, rozdzielczosc, typ) VALUES (-1, -1, 'inny');

```

### 4

1: Żaden model się nie powtarza, bo nazwa dla każdego aparatu jest inna.

2: Nie, brakuje: CREATE ROUTINE
...
Odp: Tak, znikły aparaty wyprodukowane przez producentów z Chin (-5).
...
1: Nie, nie może być stworzony.

2: Tak, będzie działał.
